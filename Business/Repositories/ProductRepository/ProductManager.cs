    ...
    public class ProductManager : IProductService
    {
        ...
        public async Task<IResult> Delete(Product product)
        {
            IResult result = BusinessRules.Run(
                await ChackIfProductExistToBaskets(product.Id),
                await ChackIfProductExistToOrderDetails(product.Id)
                );
            if (result != null)
            {
                return result;
            ...
            foreach (var productitem in priceListProducts)
            {
                await _priceListDetailService.Delete(productitem);
            }
        ...
        public async Task<IResult> ChackIfProductExistToBaskets(int productId)
        {
        ...
        public async Task<IResult> ChackIfProductExistToOrderDetails(int productId)
        {
